...
serve(async (req) => {
  ...
  try {
    const { subject, classLevel, country, topic, additionalNotes } = await req.json();
...
Sub-topic: [Generate an appropriate sub-topic]
...
- [List 4-5 specific, relevant teaching aids]
